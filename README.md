...
En este proyecto se utilizará `VirtualBox`
...
2. Instalar Rocky Linux + Configuración inicial
3. Configurar almacenamiento (RAID + LVM)  
4. Configurar seguridad del servidor  
5. Automatizar configuraciones con Ansible
